...
from acaiplus.utils.engines import create_vae_acai_trainer, create_evaluator
...
def main(cfg):
    ...
    if cfg.MODEL.MODE.lower() in 'training':
        ...
        trainer = create_vae_acai_trainer(models=models_dict, custom_loss=layers.custom_loss, cfg=cfg)
